...
public class sorpresa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String usuario = getIntent().getStringExtra("txt_usuario");
        if (usuario != null){
    ...
    public void terminarPartida(){
        if (estado == 1 || estado == -1){
            if (estado == 1){
                ...
                txt_victoria.setVisibility(View.VISIBLE);
                txt_victoria.setTextColor(Color.RED);
                txt_victoria.setText("Has perdido :c");
            }
    ...
    public void resetGame(View v) {
        ...
        for (int id : botones) {
            ...
            button.setText("");
            button.setTextColor(getResources().getColor(com.google.android.material.R.color.design_default_color_primary_dark,null));
        }
